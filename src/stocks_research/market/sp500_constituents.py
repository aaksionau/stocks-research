"""S&P 500 ticker symbols, in yfinance notation (e.g. BRK-B, not BRK.B).

Source: https://github.com/datasets/s-and-p-500-companies (constituents.csv), fetched 2026-08-03.
This list drifts as index membership changes; refresh periodically from the same source.
"""
